          ...
          {user.trainingDays.map((trainingDays, t) => (
            ...
            >
              ...
              <button
                ...
                className={`${getColorClassForType(trainingDays.type)} ${dayId === trainingDays.$id ? "opacity-30" : ""} flex w-44 flex-col items-center gap-2 rounded-md border border-slate-700 p-2 text-white shadow-md shadow-slate-800`}
              >
